...
> **v2.5.0** (2026-09-15) ships the v3 contracts axis' first tranche — typed durability receipts, gateway caller identity, the AE evaluator seam, threat model rev 2, the replay nondeterminism inventory. Wire v12 unchanged.
>
