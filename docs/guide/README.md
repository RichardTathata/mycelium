...
| [Deprecations](deprecations.md) | **What is on the way out, and what to do about it** — the adopter-facing half of the `3.0.0` removal ledger: the replacement for each entry, the migration, and whether the compiler will warn you (mostly it will not). Nothing listed is removed on 2.x | — | 6 min |
