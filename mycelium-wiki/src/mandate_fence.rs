...
/// The authority-at-execution seam, defined in the store module since closure plan C6 so the
/// filesystem store can use it too. Re-exported here, where the git store introduced it.
pub use crate::store::WriteAuthority;
